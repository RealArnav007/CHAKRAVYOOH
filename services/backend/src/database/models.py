...
class Alert(Base):
    """
    Actionable warnings generated by the Risk Engine for Pukar realtime and offline mesh delivery.
    """
    ...
    ttl_s = Column(Integer, default=86400)                # Time to live in seconds
